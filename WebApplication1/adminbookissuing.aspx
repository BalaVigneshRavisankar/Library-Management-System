                             ...
                             <div class="col-md-6">
                                 <label>Member ID</label>
                                  <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox2" runat="server" placeholder="Member ID"></asp:TextBox><br>
                                </div>
                        ...
                        <div class="row">
                             ...
                             <div class="col-md-6">
                                 <label>Member Name</label>
                                  <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" placeholder="Member Name" ReadOnly="True"></asp:TextBox><br>
                                </div>
                               ...
                               <div class="col-md-6">
                                 <label>Book Name</label>
                                  <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="Book Name" ReadOnly="True"></asp:TextBox><br>
                                </div>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-6">
                                 <label>State Date</label>
                                  <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox5" runat="server" placeholder="State Date" TextMode="Date" ></asp:TextBox><br>
                                </div>
                               ...
                               <div class="col-md-6">
                                 <label>Due Date</label>
                                  <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox6" runat="server" placeholder="End Date" TextMode="Date" ></asp:TextBox><br>
                                </div>
                         ...
                         <div class="row">
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <asp:Button ID="Button2" class="btn btn-primary me-md-2" runat="server" Text="Issue" OnClick="Button2_Click"/>
                            </div>
                           
                            <div class="d-grid gap-2 col-6 mx-auto">
                                <asp:Button ID="Button4" class="btn btn-danger me-md-2" runat="server" Text="Return" OnClick="Button4_Click"/>
                            </div>
                         </div>
