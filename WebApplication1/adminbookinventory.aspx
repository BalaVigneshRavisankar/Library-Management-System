                        ...
                        <div class="row">
                         ...
                         <div class="row">
                             ...
                             <div class="d-grid gap-2 col-4">
                                <asp:Button ID="Button1" class="btn btn-success me-md-2" runat="server" Text="Add" OnClick="Button1_Click" />
                                </div>
                            ...
                            <div class="d-grid gap-2 col-4">
                                <asp:Button ID="Button2" class="btn btn-danger me-md-2" runat="server" Text="Delete" OnClick="Button2_Click" />
                                </div>
                            </div>
